...
class _PaywallScreenState extends State<PaywallScreen> {
            ...
            children: [
              Padding(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    // Badge space if needed
                    if (badge != null) const SizedBox(height: 28),
              ...
              // Badge - positioned above content
              if (badge != null)
                Positioned(
                  top: 0,
                  right: 0,
  ...
  String _getButtonText() {
    switch (_selectedPlan) {
      case 'monthly':
        return 'Start 3-Day Free Trial - Monthly';
      case 'annual':
        return 'Start 3-Day Free Trial - Annual';
      case 'lifetime':
        return 'Buy Lifetime Access - \$79.99';
      default:
        return 'Continue';
    }
  }
